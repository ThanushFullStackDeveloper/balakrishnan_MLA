...
const LeadCaptureSection = ({ language, translations }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const baseUrl = 'https://docs.google.com/forms/d/e/1FAIpQLSdKL_Ay9DaK2z_u4mrDKr8_zohCWrykKrmqFImDu1Guaq9ZFw/formResponse';
      
      // Create form data for Google Forms
      const googleFormData = new URLSearchParams({
        'entry.2110418141': formData.name,
        'entry.1697754964': formData.phone,
        'entry.1398086878': formData.village,
        'entry.959656840': formData.concern,
        'entry.792003302': formData.volunteer ? 'I want to volunteer' : ''
      });
